        ...
        <div ref={aboutRef} className='fixed top-0 left-0 w-screen h-[600lvh] bg-paper z-10 translate-y-[100lvh] overflow-hidden transition-transform duration-150 ease-out'>
          ...
          <div ref={aboutContentRef}>
            ...
            <div>
              ...
              <div
                ref={aboutUsBtnRef}
                className='absolute w-fit h-fit z-30 pointer-events-auto -top-[12lvh] right-0 lg:top-0 lg:right-0 opacity-0 -translate-x-[12vw] translate-y-[65lvh] leading-normal transition-all duration-1000 ease-in-out'
              >
            ...
            <div>
              ...
              <div
                ref={whereBtnRef}
                className='absolute w-fit h-fit z-30 pointer-events-auto top-64 lg:top-0 right-0 opacity-0 -translate-x-[15vw] translate-y-[52lvh] leading-normal transition-all duration-1000 ease-in-out'
              >
